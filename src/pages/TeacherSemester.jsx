...
export default function TeacherSemester() {
  ...
  const activeModule = location.pathname.split('/')[4] || 'dashboard'
  ...
  const navigateModule = (module) => navigate(module === 'dashboard' ? `/teacher/semester/${semester}` : `/teacher/semester/${semester}/${module}`)
  let content
  if (activeModule === 'students') content = <SemesterStudents user={user} semester={semester} students={students} onNavigate={navigateModule} />
  else if (activeModule === 'attendance') content = <SemesterAttendance user={user} semester={semester} students={students} />
  else if (activeModule === 'marks') content = <SemesterMarks user={user} semester={semester} students={students} />
  ...
  return <TeacherShell user={user} semester={semester} activeModule={activeModule} onLogout={signOut}>{content}{toast && <div className="toast"><FiCheckCircle /> {toast}</div>}</TeacherShell>
}
