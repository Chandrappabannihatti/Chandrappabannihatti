...
export default function TeacherSemester() {
  ...
  const navigateModule = (module, id) => { if (module === 'student') return navigate(`/teacher/semester/${semester}/student/${id}`); if (module === 'newStudent') return navigate(`/teacher/semester/${semester}/students/new`); if (module === 'uploadStudents') return navigate(`/teacher/semester/${semester}/students/upload`); navigate(module === 'dashboard' ? `/teacher/semester/${semester}` : `/teacher/semester/${semester}/${module}`) }
