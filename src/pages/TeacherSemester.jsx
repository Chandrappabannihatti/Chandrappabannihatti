...
export default function TeacherSemester() {
  ...
  const navigateModule = (module, id) => { if (module === 'student') return navigate(`/teacher/semester/${semester}/student/${id}`); navigate(module === 'dashboard' ? `/teacher/semester/${semester}` : `/teacher/semester/${semester}/${module}`) }
