...
import { achievementTypes, cloneDemoStudents, demoAchievements, demoAnnouncements, demoMessages, demoRemarks, demoSections } from '../data/demo'
...
export default function TeacherSemester() {
  ...
  useEffect(() => {
    ...
    ]).then(([sectionResult, studentResult, announcementResult, messageResult, remarkResult, achievementResult]) => {
      if (!mounted) return
