...
import { FiArrowRight, FiCheckCircle, FiChevronRight, FiLogOut, FiShield } from 'react-icons/fi'
...
export default function SemesterSelection() {
  ...
  return <main className="semester-selection-page">
    ...
    <section className="selection-content">
      ...
      <div className="selection-note"><FiCheckCircle /><span>Each semester opens its own students, attendance, marks, announcements, messages, analytics and XGBoost predictions.</span><FiArrowRight /></div>
    </section>
